...
<body>
    ...
    height: 60px;"></a>
                        ...
                        <form action="search.php" method="POST" class="header-top__search">
                            <input type="text" name="tukhoa" class="header-top__search-input" placeholder="Tìm sản phẩm bạn mong muốn" value="<?php if (isset($_POST['tukhoa'])) {
                                                                                                                                                    echo $_POST["tukhoa"];
                                                                                                                                                } ?>">
                                    ...
                                    <div class="header-top__join-wrap">
                                        ...
                                        <ul class="header-top__join-menu">
                                            ...
                                            <li class="header-top__join-menu-items">
                                                <a class="header-top__join-out" href="logout.php" onclick="return confirmLogout()">Đăng xuất</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <script>
