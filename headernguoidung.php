                ...
                <div class="header-top">
                    <div class="header-top__gr">
                        <a href="index_home.php">
                            <img src="assets/img/logoabc.png" alt="" class="header-top__logo"></a>
                        <!-- <a href="#!" class="header__left">
                                <h1 class="header__left-title">Nguyễn Hương <span class="header__left-private">Shop</span></h1>
                                <span class="header__left-msg">NH<span class="header__left-private">Shop</span></span>
                                <script>
                                      // Text header-left
                                    var h1HeaderLeft = document.querySelector('.header__left-title')
                                    var strongHeaderLeft = document.querySelector('.header__left-msg')
                                    setInterval(() => {
                                        h1HeaderLeft.classList.toggle('color-black')
                                        strongHeaderLeft.classList.toggle('color-black')
                                    },2000)

                                    var h1strongHeaderRight = document.querySelectorAll('.header__left-private')
                                    h1strongHeaderRight.forEach((result) => {
                                        setInterval(() => {
                                            result.classList.toggle('color-white')
                                        },2000)
                                    })
                                </script>
                            </a> -->
                        <form action="search.php" method="POST" class="header-top__search">
                            <input type="text" name="tukhoa" class="header-top__search-input"
                                ...
                                value="<?php if (isset($_POST['tukhoa'])) {
                                                                                                                                                    echo $_POST["tukhoa"];
                                                                                                                                                } ?>">
                            ...
                            <div class="header-top__join">
                                ...
                                function confirmLogout() {
                                    if (confirm('Bạn có chắc chắn muốn đăng xuất không?')) {
                                        ...
                                        'logout.php'; // Chuyển hướng đến trang logout.php nếu xác nhận
                                        return true;
                                    } else {
                                        return false;
                                    }
                ...
                <div class="grid wide">
                    <div class="header-bottom__gr">
                        <ul class="header-bottom__list">
                            <li class="header-bottom__items"><a href="index_home.php"
                                    class="header-bottom__items-link">Trang chủ</a></li>
                            ...
                            <li class="header-bottom__items"><a href="index_news.php"
                                    class="header-bottom__items-link">Tin tức</a></li>
                            <li class="header-bottom__items"><a href="contact.php"
                                    class="header-bottom__items-link">Liên hệ</a></li>
                        </ul>
                        <div class="header-bottom__call">
                            <span class="header-bottom__call-msg">
                                ...
                                <span class="header-bottom__call-msg-text">
                                    Số điện thoại:
                                    <a href="tel:0984 69 2509" class="header-bottom__call-msg-num">0984 69 2509</a>
                                </span>
                            </span>
                        </div>
                    </div>
