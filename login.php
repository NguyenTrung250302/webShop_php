...
if (isset($_POST['ok'])) {
    ...
    $user = checklogin($tendangnhap, $matkhau);
    if ($user) {
        if (!isset($_SESSION)) {
            session_start();
        }
        ...
        if ($user['role_id'] == 1) {
            ...
            header('Location: headerquantri.php');
        } else {
            echo "<script>alert('Sai quyền truy cập')</script>";
        }
    } else {
...
<form action="login.php" method="post" class="relog">
    ...
    <div class="relog-form">
        ...
        <p class="relog-form__title">Nếu bạn chưa có tài khoản, <a href="register.php" class="relog-form__link">đăng
                ký</a> tại đây</p>
    ...
    <!-- <a title="Sang trang Quản lý" href="headerquantri.php" class="relog-form__back-icon">
        <i class=" fa-solid fa-arrow-left"></i>
