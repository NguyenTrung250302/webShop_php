                        ...
                        <div class='info-product__table-after'>
                            ...
                            <div class='info-product__table-container'>
                                <div class='info-product__container-left'>
                                    <img src='./upload/<?= $detail['img'] ?>' alt=''
                                        class='info-product__container-left-img'>
                                </div>
                            ...
                            <div class='info-product__table-footer'>
                                <p class='info-product__footer-top'>Thành Tiền : <span
                                        class='info-product__footer-top-money'><?= $order['total'] ?> đ</span></p>
                                <div class='info-product__footer-bottom'>
                                    ...
                                    <form method="post" action="huy-don-hang.php" class='info-product__footer-right'>
                                        ...
                                        <button type="submit" class="info-product__footer-cancel"
                                            name="huy_don_hang">Hủy đơn hàng</button>
                                    </form>
                                </div>
                            </div>
                        </div>
